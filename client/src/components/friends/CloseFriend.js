...
const CloseFriend = () => {
  ...
  const close = async (event) => {
    ...
    FriendDataService.updateCloseFriend(currentUser.id, id)
      .then((res) => {
        console.log(res.data);
      })
      .catch((e) => {
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6">
              <h4>Do you want to make this friend a close friend?</h4>
