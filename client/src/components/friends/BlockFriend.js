...
const BlockFriend = () => {
  ...
  const block = async (event) => {
    ...
    FriendDataService.updateBlockFriend(currentUser.id, currentFriend.id)
    FriendDataService.updateBlockFriend(currentFriend.id, currentUser.id)
      .then((res) => {
        console.log(res.data);
      })
      .catch((e) => {
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6">
              <h4>Do you want to Block this friend?</h4>
